...
export default function UserForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        e.preventDefault();
        setLoading(true);
        const data: any = { ...formData, role_id: formData.role_id ? parseInt(formData.role_id) : undefined };
        // Remove password fields if they are empty strings to prevent backend validation errors
